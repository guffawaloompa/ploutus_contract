...
contract StakingPlatform is IStakingPlatform, Ownable {
     ...
     */
    constructor(
        //address _token = 0x9fac592CCC7DBe03f3A4c128ff0E59127251E7C5,
        //uint8 _fixedAPY,
        ...
        address _token = 0x9fac592CCC7DBe03f3A4c128ff0E59127251E7C5;
        stakingDuration = _durationInDays * 1 hours;
        lockupDuration = _lockDurationInDays * 1 hours;
        token = IERC20(_token);
        fixedAPY = 100; //_fixedAPY;
        stakingMax = IERC20(token).totalSupply(); // _maxAmountStaked * (10**18);
    }
    ...
    function withdrawAll() external override {
        ...
        staked[_msgSender()] = 0;
        token.transfer(_msgSender(), stakedBalance);
    ...
    function _claimRewards() private {
        ...
        token.transfer(_msgSender(), rewardsToClaim);
